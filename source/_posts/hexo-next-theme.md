...
> 最近又美化(折腾)了一下博客, 更换了主题, 升级了[hexo-next](https://github.com/next-theme/hexo-theme-next)到最新版本
...
升级了最新的[hexo-next](https://github.com/next-theme/hexo-theme-next)主题之后, 作者已经做了这部分处理, 可以放心食用了
